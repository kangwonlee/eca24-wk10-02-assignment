...
# Integrating $cos\theta$ (instead of $sin \theta$) using 1st order<br>1차 적분을 이용한 ($sin \theta$ 대신) $cos \theta$ 적분

## Description<br>설명

* Using numerical integration of 1st order, please calculate definite integral of $cos \theta$ (instead of $sin \theta$ in the video).<br>1차 수치 적분을 사용하여 (비디오에서는 $sin \theta$ 였지만) $cos \theta$의 정적분을 계산하시오.
* Please compare with results from 0th order and exact definite integral.<br>0차 적분과 이론 정적분값과도 비교하시오.
...
|:----------------:|:------------------:|
| `int_cos_1()` | calculate definite integral of $cos \theta$ using numerical integration of 0th order<br>1차 수치 적분을 사용하여 $cos \theta$의 정적분을 계산 |
